...
Generative Agents的原始代码工程化程度较低，难以持续维护或拓展功能，且时隔两年，中文LLM的能力早已胜任此类任务。我们对原项目的重构+深度汉化版本[GenerativeAgentsCn](https://github.com/x-glacier/GenerativeAgentsCN.git)
进行了自己的重构版本进行了语言涌现的实验。
